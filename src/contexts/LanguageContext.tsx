...
export const translations: Translations = {
  ...
  libraryOf: { en: '{name}’s library', ru: 'Библиотека {name}' },
  openFullLibrary: { en: 'Open full library', ru: 'Открыть всю библиотеку' },
  hasRating: { en: 'Has rating', ru: 'С оценкой' },
  hasReview: { en: 'Has review', ru: 'С отзывом' },
  addedAfter: { en: 'Added after', ru: 'Добавлено после' },
  addedBefore: { en: 'Added before', ru: 'Добавлено до' },
  addedOn: { en: 'Added {date}', ru: 'Добавлено {date}' },
  author: { en: 'Author', ru: 'Автор' },
  compareAll: { en: 'All', ru: 'Все' },
  compareShared: { en: 'We both have', ru: 'У нас обоих' },
  compareOnlyTheirs: { en: 'Not in mine', ru: 'Нет у меня' },
  onYourShelf: { en: 'On your shelf', ru: 'На вашей полке' },
  notInYourLibrary: { en: 'Not in your library', ru: 'Нет в вашей библиотеке' },
  yourRatingVs: { en: 'You {you} · {name} {them}', ru: 'Вы {you} · {name} {them}' },
  readingPace: { en: '{pace}/day', ru: '{pace}/день' },
  daysReading: { en: '{days}d reading', ru: '{days} дн. чтения' },
  showMore: { en: 'Show more', ru: 'Ещё' },
  showLess: { en: 'Show less', ru: 'Свернуть' },
  watchProgress: { en: 'Watch progress', ru: 'Прогресс просмотра' },
  historyTitle: { en: 'History', ru: 'История' },
  histAdded: { en: 'Added to library', ru: 'Добавлено в библиотеку' },
  histStarted: { en: 'Started', ru: 'Начато' },
  histFinished: { en: 'Finished', ru: 'Завершено' },
  histRated: { en: 'Rated {rating}', ru: 'Оценка {rating}' },
  histReviewed: { en: 'Wrote a review', ru: 'Написан отзыв' },
  histProgress: { en: 'Progress', ru: 'Прогресс' },
  ...
  shelfDNF: { en: 'Did not finish', ru: 'Брошено' },
  collections: { en: 'Collections', ru: 'Коллекции' },
  newCollection: { en: 'New collection', ru: 'Новая коллекция' },
  collectionName: { en: 'Name…', ru: 'Название…' },
  createCollection: { en: 'Create', ru: 'Создать' },
  noCollections: { en: 'No collections yet', ru: 'Нет коллекций' },
  myCollections: { en: 'My collections', ru: 'Мои коллекции' },
  didNotFinish: { en: 'Did not finish', ru: 'Брошено' },
  ...
  verbDnf: { en: 'gave up on', ru: 'бросил(а)' },
  ...
  popularNow: { en: 'Popular now', ru: 'Сейчас популярно' },
  newAndNoteworthy: { en: 'New & noteworthy', ru: 'Новое и заметное' },
  newReleases: { en: 'New releases', ru: 'Новинки' },
  browseByGenre: { en: 'Browse by genre', ru: 'По жанрам' },
  notableNames: { en: 'Notable names', ru: 'Известные имена' },
  nTitles: { en: '{n} titles', ru: '{n} в каталоге' },
  inLibrariesLabel: { en: '{n} in libraries', ru: '{n} в библиотеках' },
  signInToAdd: { en: 'Sign in to add', ru: 'Войдите, чтобы добавить' },
  ...
  sortReviewed: { en: 'Reviewed first', ru: 'Сначала с отзывом' },
  viewReview: { en: 'View review', ru: 'Посмотреть отзыв' },
  ...
  importFromTmdb: { en: 'Import from TMDB', ru: 'Импорт из TMDB' },
  tmdbSuggestTitle: { en: 'TMDB match found', ru: 'Найдено совпадение TMDB' },
  tmdbSuggestHint: {
    en: 'Use this TMDB record? It fills in the bio, photo, birth date and name variants — your existing values stay unless TMDB has a value.',
    ru: 'Использовать эту запись TMDB? Она заполнит биографию, фото, дату рождения и варианты имени — ваши значения сохранятся, если в TMDB пусто.',
  },
  tmdbNoMatch: { en: 'No TMDB match found for this name.', ru: 'Совпадений в TMDB по имени не найдено.' },
  ...
  exportLibrary: { en: 'Export library', ru: 'Экспорт библиотеки' },
  exportFormat: { en: 'Format', ru: 'Формат' },
  exportCsvHint: { en: 'Opens in Excel / Google Sheets', ru: 'Открывается в Excel / Google Таблицах' },
  exportJsonHint: { en: 'Structured data for developers', ru: 'Структурированные данные для разработчиков' },
  exportType: { en: 'Type', ru: 'Тип' },
  exportStatus: { en: 'Shelf status', ru: 'Статус полки' },
  exportCollection: { en: 'Collection', ru: 'Коллекция' },
  exportFinishedRange: { en: 'Finished between', ru: 'Завершено между' },
  exportDownload: { en: 'Download', ru: 'Скачать' },
  exporting: { en: 'Exporting…', ru: 'Экспорт…' },
  exportFields: { en: 'Fields', ru: 'Поля' },
  exportColField: { en: 'Field', ru: 'Поле' },
  exportColKey: { en: 'Column name', ru: 'Имя столбца' },
  exportSelectAll: { en: 'Select all', ru: 'Выбрать все' },
  exportSelectNone: { en: 'None', ru: 'Снять все' },
  exportGroupCore: { en: 'Core', ru: 'Основные' },
  exportGroupBasic: { en: 'Basic', ru: 'Общее' },
  exportGroupDates: { en: 'Dates', ru: 'Даты' },
  exportGroupPersonal: { en: 'Personal', ru: 'Личное' },
  exportGroupBooks: { en: 'Books', ru: 'Книги' },
  exportGroupMedia: { en: 'Movies & Series', ru: 'Фильмы и сериалы' },
  exportFieldTitle: { en: 'Title', ru: 'Название' },
  exportFieldType: { en: 'Type', ru: 'Тип' },
  exportFieldStatus: { en: 'Status', ru: 'Статус' },
  exportFieldOriginalTitle: { en: 'Original title', ru: 'Оригинальное название' },
  exportFieldAuthor: { en: 'Author / Director', ru: 'Автор / Режиссёр' },
  exportFieldYear: { en: 'Year', ru: 'Год' },
  exportFieldGenre: { en: 'Genre', ru: 'Жанр' },
  exportFieldStartedAt: { en: 'Started', ru: 'Начато' },
  exportFieldFinishedAt: { en: 'Finished', ru: 'Завершено' },
  exportFieldAddedAt: { en: 'Date added', ru: 'Добавлено' },
  exportFieldRating: { en: 'Rating', ru: 'Оценка' },
  exportFieldReview: { en: 'Review', ru: 'Рецензия' },
  exportFieldCollections: { en: 'Collections', ru: 'Коллекции' },
  exportFieldFavorite: { en: 'Favorite', ru: 'Избранное' },
  exportFieldPages: { en: 'Pages', ru: 'Страниц' },
  exportFieldDuration: { en: 'Duration', ru: 'Длительность' },
  exportFieldISBN: { en: 'ISBN', ru: 'ISBN' },
  exportFieldLanguage: { en: 'Language', ru: 'Язык' },
  exportFieldPublisher: { en: 'Publisher', ru: 'Издательство' },
  allCollections: { en: 'All collections', ru: 'Все коллекции' },
};
